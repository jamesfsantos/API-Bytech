...
namespace ByTech_API.Data.Configurations
{
    public class ServicoManutencaoConfiguration : IEntityTypeConfiguration<ServicoManutencao>
    {
        ...
        {
            builder.ToTable("Servicos_Manutencao");
            builder.Property(x => x.Id).HasColumnName("id");
            builder.Property(x => x.Protocolo).HasColumnName("protocolo").IsRequired();
            ...
            builder.Property(x => x.Data_Entrada).HasColumnName("data_entrada");
